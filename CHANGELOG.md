...
- A portable `skills/chorus-agent` package and `chorus-skill-install` CLI for installing the same Chorus workflow into Codex and Claude Code project or user scopes in copy or link mode.
